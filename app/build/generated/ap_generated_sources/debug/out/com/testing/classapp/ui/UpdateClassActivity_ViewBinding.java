...
public class UpdateClassActivity_ViewBinding implements Unbinder {
  private UpdateClassActivity target;

  private View view7f08004a;

  @UiThread
  public UpdateClassActivity_ViewBinding(UpdateClassActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public UpdateClassActivity_ViewBinding(final UpdateClassActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    UpdateClassActivity target = this.target;
